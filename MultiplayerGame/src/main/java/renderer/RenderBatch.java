...
public class RenderBatch implements Comparable<RenderBatch> {
	// Vertex
	// ==========
	// Position				Color								TexCoords		Tex id
	...
	public void addSprite(SpriteRenderer spr) {
		...
		if(spr.getTexture() != null) {
			if(!textures.contains(spr.getTexture())) {
				...
				//TODO stop it from filling up with textures
			}
		}
	...
	public void render() {
		...
		// Use shader
		shader.use();
		shader.uploadMat4f("uProjection", Window.getScene().getCamera().getProjMatrix4f());
